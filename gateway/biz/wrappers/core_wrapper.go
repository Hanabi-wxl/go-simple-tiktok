...
func (wrapper *coreWrapper) Call(ctx context.Context, req client.Request, resp interface{}, opts ...client.CallOption) error {
...
// NewCoreWrapper 初始化Wrapper
func NewCoreWrapper(c client.Client) client.Client {
	return &coreWrapper{c}
}
