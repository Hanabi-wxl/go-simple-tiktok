...
func (c *relationService) MessageAction(ctx context.Context, in *DouyinMessageActionRequest, opts ...client.CallOption) (*DouyinMessageActionResponse, error) {
...
func (c *relationService) MessageChat(ctx context.Context, in *DouyinMessageChatRequest, opts ...client.CallOption) (*DouyinMessageChatResponse, error) {
...
func (h *relationServiceHandler) MessageAction(ctx context.Context, in *DouyinMessageActionRequest, out *DouyinMessageActionResponse) error {
	return h.RelationServiceHandler.MessageAction(ctx, in, out)
}

func (h *relationServiceHandler) MessageChat(ctx context.Context, in *DouyinMessageChatRequest, out *DouyinMessageChatResponse) error {
