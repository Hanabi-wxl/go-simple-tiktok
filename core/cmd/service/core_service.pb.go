...
type DouyinUserLoginResponse struct {
	...
	Avatar          *string `protobuf:"bytes,5,req,name=avatar" json:"avatar,omitempty"`                                          // 用户头像
	BackgroundImage *string `protobuf:"bytes,6,req,name=background_image,json=backgroundImage" json:"background_image,omitempty"` // 背景
}
...
func (x *DouyinUserLoginResponse) GetAvatar() string {
...
func (x *DouyinUserLoginResponse) GetBackgroundImage() string {
...
type DouyinUserRegisterResponse struct {
	...
	Token           *string `protobuf:"bytes,4,req,name=token" json:"token,omitempty"`                              // 用户鉴权token
	Avatar          *string `protobuf:"bytes,5,req,name=avatar" json:"avatar,omitempty"`                            // 用户头像
	BackgroundImage *string `protobuf:"bytes,6,req,name=background_image,json=backgroundImage" json:"background_image,omitempty"`
}
...
func (x *DouyinUserRegisterResponse) GetAvatar() string {
	if x != nil && x.Avatar != nil {
		return *x.Avatar
	}
	return ""
...
func (x *DouyinUserRegisterResponse) GetBackgroundImage() string {
	if x != nil && x.BackgroundImage != nil {
		return *x.BackgroundImage
	}
	return ""
...
var file_core_service_proto_rawDesc = []byte{
	...
	0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0xce, 0x01, 0x0a, 0x1a, 0x64, 0x6f,
	...
	0x72, 0x18, 0x05, 0x20, 0x02, 0x28, 0x09, 0x52, 0x06, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x12,
	0x29, 0x0a, 0x10, 0x62, 0x61, 0x63, 0x6b, 0x67, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x5f, 0x69, 0x6d,
	0x61, 0x67, 0x65, 0x18, 0x06, 0x20, 0x02, 0x28, 0x09, 0x52, 0x0f, 0x62, 0x61, 0x63, 0x6b, 0x67,
	0x72, 0x6f, 0x75, 0x6e, 0x64, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x22, 0x56, 0x0a, 0x1c, 0x64, 0x6f,
	...
	0x72, 0x64, 0x22, 0xd1, 0x01, 0x0a, 0x1d, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x75, 0x73,
	...
	0x02, 0x28, 0x09, 0x52, 0x06, 0x61, 0x76, 0x61, 0x74, 0x61, 0x72, 0x12, 0x29, 0x0a, 0x10, 0x62,
	0x61, 0x63, 0x6b, 0x67, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x5f, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18,
	0x06, 0x20, 0x02, 0x28, 0x09, 0x52, 0x0f, 0x62, 0x61, 0x63, 0x6b, 0x67, 0x72, 0x6f, 0x75, 0x6e,
	0x64, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x32, 0x8a, 0x04, 0x0a, 0x0b, 0x43, 0x6f, 0x72, 0x65, 0x53,
	...
	0x6e, 0x73, 0x65, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2f, 0x3b, 0x69, 0x64, 0x6c,
}
